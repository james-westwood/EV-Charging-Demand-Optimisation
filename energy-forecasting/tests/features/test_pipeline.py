...
def test_feature_pipeline_synthetic_large_data() -> None:
    ...
    carbon_df = pd.DataFrame({
        ...
        "intensity_actual": [150.0] * 400,
        "intensity_forecast": [150.0] * 400
    })
    
    gen_df = pd.DataFrame({
        "settlement_period": periods,
        "gas": [1000.0] * 400, "coal": [0.0] * 400, "nuclear": [500.0] * 400,
        "wind": [300.0] * 400, "hydro": [10.0] * 400, "imports": [5.0] * 400,
        "biomass": [20.0] * 400, "other": [2.0] * 400, "solar": [50.0] * 400
    })
    ...
    for city in ["London", "Manchester", "Edinburgh"]:
        for p in weather_periods:
            weather_rows.append({
                "city": city, "timestamp": p,
                "temperature": 15.0, "wind_speed": 10.0, "radiation": 100.0
            })
